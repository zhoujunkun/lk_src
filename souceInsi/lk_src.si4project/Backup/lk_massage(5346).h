...
#define waveParamCfg(name,pulse,hz,repeat)  waveParam_t name ={pulse,(SystemClkFreq)/(TimeFreqPSC*hz),repeat}
...
{
	{easyModeArray,sizeof(easyModeArray)/sizeof(massageWaveCfg_t)},
};
